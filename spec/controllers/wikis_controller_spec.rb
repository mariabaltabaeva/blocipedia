...
RSpec.describe WikisController, type: :controller do
  ...
  describe "GET #new" do
    ...
    describe "POST create" do
      it "increases the number of Wiki by 1" do
        expect{ post :create, params: { wiki: { title: "New Wiki Title", body: "New Wiki Body", private: false, user: user } } }.to change(Wiki,:count).by(1)
      end
  ...
  describe "GET show" do
   ...
   describe "GET edit" do
     ...
     it "assigns wiki to be updated to @wikis_path" do
       get :edit, params: { id: my_wiki.id }
